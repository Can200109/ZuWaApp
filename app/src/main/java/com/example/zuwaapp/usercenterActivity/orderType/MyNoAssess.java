...
public class MyNoAssess extends AppCompatActivity {
    private Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_no_assess);

        back = findViewById(R.id.no_assess_return);
        ...
        //查数据库初始化数据
        OrderType orderTypeData = new OrderType(Constant.PHONENUMBER,"待评价");
        new Method().findOrder(orderTypeData,handler);

        /**
         * 这里缩进有问题是因为之前想进行一点骚操作，结果发现不太行，懒得想为什么了
         * 直接删掉改布局文件，简单粗暴
         * **/
             ...
             **/
            ListView noPaymentOrderList = findViewById(R.id.my_no_assess_page_list);
            Log.e("数据",productList.size()+"");
            Log.e("数据",productList.toString()+"");
            noPaymentAdapter = new RentAdapter(productList,R.layout.my_noassess_list_pro,MyNoAssess.this);
