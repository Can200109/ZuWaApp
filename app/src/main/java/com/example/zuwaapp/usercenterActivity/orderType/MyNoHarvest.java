...
public class MyNoHarvest extends AppCompatActivity {
    private Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_no_harvest);

        back =findViewById(R.id.no_harvest_return);
        ...
        //查数据库初始化数据
        OrderType orderTypeData = new OrderType(Constant.PHONENUMBER,"待收货");
        new Method().findOrder(orderTypeData,handler);
             ...
             **/
            ListView noPaymentOrderList = findViewById(R.id.my_no_harvest_page_list);
            Log.e("数据",productList.size()+"");
            Log.e("数据",productList.toString()+"");
            noPaymentAdapter = new RentAdapter(productList,R.layout.my_noharvest_list_pro,MyNoHarvest.this);
