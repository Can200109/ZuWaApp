...
public class MyNoReturn extends AppCompatActivity {
    private Button back;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_no_return);

        back = findViewById(R.id.no_return_return);
        ...
        //查数据库初始化数据
        OrderType orderTypeData = new OrderType(Constant.PHONENUMBER,"待归还");
        new Method().findOrder(orderTypeData,handler);
             ...
             **/
            ListView noPaymentOrderList = findViewById(R.id.my_no_return_page_list);
            Log.e("数据",productList.size()+"");
            Log.e("数据",productList.toString()+"");
            noPaymentAdapter = new RentAdapter(productList,R.layout.my_noreturn_list_pro,MyNoReturn.this);
